...
<?php if ( !empty($video_sound) && $video_sound ) { ?>
    <div id="audio-control" class="muted"><i class="fa-solid fa-volume-xmark"><span class="no-view-text">button for play stop video</span></i></div>
<?php } ?>
<?php if ( $video_sound ) { ?>
    <script>
...
<script>
        ...
        const checkVideoHeight = () => {
            ...
            if (videoHeight < windowHeight) {
                ...
                $ ( ".cover-content" ).css("height", "100vh");
            }
        };
