...
<div class="container-fluid p-0 m-0">
    <div class="row no-gutters mx-0" >
        <div class="col-12">
            <div class="embed-responsive embed-responsive-16by9 " style="height:560px">
                <div style="width: 100%">
                ...
                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=<?php echo $address_map_new; ?>&amp;z=<?php echo $map_zoom_level; ?>&amp;t=<?php echo $map_style; ?>&amp;ie=UTF8&amp;iwloc=B&amp;mode=d&amp;output=embed">
